...
<section>
  ...
  <section>
    ...
    <div className="wide grid md:grid-cols-7 gap-4">
      <Image divClassName="md:col-span-2 my-auto rounded-xl" src="user-testing-1.jpg"/>
      <Image divClassName="md:col-span-3 rounded-xl" src="portrait-1.jpg"/>
      <Image divClassName="md:col-span-2 my-auto rounded-xl" src="user-testing-2.jpg"/>
    </div>
  </section>
</section>
...
<section>
  ...
  <section>
    ...
    >
    > Ministry of Transportation product owner
  </section>

  <section>
    Our findings proved instrumental in <AutoLink to="https://www.ontario.ca/page/renew-drivers-licence">the newest iteration of Ontario's online driver's licence and health card renewal platform</AutoLink>, which launched in October 2021. Here are some metrics from the launch (actual values omitted for confidentiality reasons):
  </section>
